...
public class SupportVectorDrawablesButton extends AppCompatButton {
    ...
    private void initSupportVectorDrawablesAttrs(AttributeSet attrs) {
        ...
        TypedArray attributeArray = getContext().obtainStyledAttributes(
                attrs,
                com.firebase.ui.auth.R.styleable.SupportVectorDrawablesButton);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            drawableStart = attributeArray.getDrawable(
                    com.firebase.ui.auth.R.styleable.SupportVectorDrawablesButton_drawableStartCompat);
            drawableEnd = attributeArray.getDrawable(
                    com.firebase.ui.auth.R.styleable.SupportVectorDrawablesButton_drawableEndCompat);
            drawableTop = attributeArray.getDrawable(
                    com.firebase.ui.auth.R.styleable.SupportVectorDrawablesButton_drawableTopCompat);
            drawableBottom = attributeArray.getDrawable(
                    com.firebase.ui.auth.R.styleable.SupportVectorDrawablesButton_drawableBottomCompat);
        } else {
            int drawableStartId = attributeArray.getResourceId(
                    com.firebase.ui.auth.R.styleable.SupportVectorDrawablesButton_drawableStartCompat, -1);
            int drawableEndId = attributeArray.getResourceId(
                    com.firebase.ui.auth.R.styleable.SupportVectorDrawablesButton_drawableEndCompat, -1);
            int drawableTopId = attributeArray.getResourceId(
                    com.firebase.ui.auth.R.styleable.SupportVectorDrawablesButton_drawableTopCompat, -1);
            int drawableBottomId = attributeArray.getResourceId(
                    com.firebase.ui.auth.R.styleable.SupportVectorDrawablesButton_drawableBottomCompat, -1);
